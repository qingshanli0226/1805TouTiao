...
public class HotspotFragment extends BaseFragment<NewsArticleContract.newsView, NewsPresenterImpl> implements NewsArticleContract.newsView {
    ...
    protected void initData() {
        ...
        httpPresenter.newsData("","1610524354");
    }
    ...
    protected void initView() {
        rvHost = findViewById(R.id.rvHost);

        newsAdapter = new NewsAdapter(R.layout.item_news, list);
        rvHost.setAdapter(newsAdapter);
        rvHost.setLayoutManager(new LinearLayoutManager(getContext()));
    }
