...
public class SocialFragment extends BaseFragment<NewsArticleContract.newsView, NewsPresenterImpl> implements NewsArticleContract.newsView {
    ...
    protected void initData() {
        ...
        //&max_behot_time=
        httpPresenter.newsData("news_society", "1610584975");
    ...
    protected void initView() {
        rvSocial = findViewById(R.id.rvSocial);

        newsAdapter = new NewsAdapter(R.layout.item_news , list);
        rvSocial.setAdapter(newsAdapter);
