...
public class TVFragment extends BaseFragment<NewsArticleContract.newsView, NewsPresenterImpl> implements NewsArticleContract.newsView {
    ...
    protected void initData() {
        //&max_behot_time=
        httpPresenter.newsData("video", "1610584389");
    }
    ...
    protected void initView() {
        ...
        newsAdapter = new NewsAdapter(R.layout.item_video, list);
        rvTv.setAdapter(newsAdapter);
