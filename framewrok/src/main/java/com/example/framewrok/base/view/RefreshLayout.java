...
import com.example.framewrok.R;
        ...
        recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(@NonNull RecyclerView recyclerView, int newState) {
                ...
                if (layoutManager instanceof LinearLayoutManager){
                    ...
                    visibleItemCount=lastItempostion-firstVisiblePosition;//获得可见的项目书
                    itemCount = recyclerView.getLayoutManager().getItemCount();//获得一共的项目数
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                super.onScrolled(recyclerView, dx, dy);
                  ...
                  if(firstItemPosition+visibleItemCount==itemCount){//第一个可见的项目数加上一共可见的项目数等于总共的项目数
                      Log.d("上拉加载", "需要上拉加载。。。");
                      isNeedLoad=true;
                  }else {
                      Log.d("不能上拉加载", "不能上拉加载。。。");
