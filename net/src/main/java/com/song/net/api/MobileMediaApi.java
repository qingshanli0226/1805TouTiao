...
import com.song.net.mode.mobile.media.MediaWendaBean;
import com.song.net.mode.mobile.media.MultiMediaArticleBean;

import io.reactivex.Observable;
import retrofit2.http.GET;
import retrofit2.http.Query;

public interface MobileMediaApi {
    /**
     * 头条号主页信息
    ...
    Observable<MediaProfileBean> getMediaProfile(@Query("media_id") String mediaId);
    ...
    Observable<MultiMediaArticleBean> getMediaArticle(@Query("media_id") String mediaId,
     ...
     * @param cursor  偏移量
     */
    @GET("wenda/profile/wendatab/loadmore/?format=json&from_channel=media_channel&count=10&offset=undefined")
