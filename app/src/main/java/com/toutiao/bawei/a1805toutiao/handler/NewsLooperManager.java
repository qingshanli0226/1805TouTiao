...
public class NewsLooperManager {
    private static volatile NewsLooperManager instance;
    ...
    private NewsLooperManager(){

    }

    public static NewsLooperManager getInstance() {
        if (instance==null) {
            synchronized (NewsLooperManager.class) {
                if (instance==null) {
                    instance = new NewsLooperManager();
                }
            }
        }
        return instance;
